        ...
        try {
            ...
            Object.entries(formData).forEach(([key, value]) => {
                if(!['presentAddressDetails', 'presentAddressDistrict', 'presentAddressDivision', 'permanentAddressDetails'].includes(key)) {
                     const finalKey = key === 'phoneNumber' ? 'phone' : key;
                     submissionData.append(finalKey, String(value)); 
                }
            });
            
            const fullAddress = `${formData.presentAddressDetails}, ${formData.presentAddressDistrict}, ${formData.presentAddressDivision}`;
                ...
                <div className={styles.formBody}>
                    ...
                    <div className={styles.formRow}>
                        <div className={styles.formGroup}>
                            <CustomDateTimePicker label="Birth Date" type="date" value={formData.dateOfBirth ? new Date(formData.dateOfBirth) : null} onChange={handleDateChange('dateOfBirth')} required={true} />
                        </div>
